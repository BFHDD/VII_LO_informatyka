...
program SortowanieBombelkowe_Wizualizacja;
...
begin
   ...
   begin
       ...
       bar(i*round(getmaxx/X),getmaxy,(i+1)*round(getmaxx/X)-1,0);
       SetFillStyle(SolidFill,white);
       bar(i*round(getmaxx/X),getmaxy,(i+1)*round(getmaxx/X)-1,getmaxy-(lista[i]*round(getmaxy/1000)));
   end;
   delay(1000);
end;
begin
